  ...
  return (
    <div className="container-fluid mb-4" style={MainContentOfAccCSS}>
          ...
          <div className="d-flex container-of-infoacc align-items-center">
            ...
            <div className="info1 pb-3">
              <div className="oapme d-inline-flex">
                <div className="username-require d-inline">
                  Nume utilizator:{" "}
                </div>
                <input type="text" readOnly id="username-add" minLength="8" />
              </div>
            ...
            <div className="info3 pb-3">
              <div className="oapme d-inline-flex">
                ...
                <input type="email" readOnly id="email-add" minLength="8" />
              </div>
              <div className="tltp-feature d-inline">
                <img
                  src="https://imj31us4am50.github.io/imgs/edit-pencil-icon.png"
      ...
      <div className="container-of-liked">
        <div className="liked-content-title h1 p-3 m-0 text-center">
          Articole apreciate
        </div>
        <div className="proper-liked-content text-center opacity-50 h5 m-0 p-5">
          unavailable atm
        </div>
      </div>
    </div>
